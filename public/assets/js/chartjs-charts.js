(function () {
    ...
    const data4 = {
        ...
        datasets: [{
            ...
            data: [10, 20, 30, 40],
            borderColor: 'rgb(68, 84, 195)',
            backgroundColor: 'rgba(68, 84, 195, 0.2)'
        }, {
            type: 'line',
            label: 'Line Dataset',
            data: [50, 50, 50, 50],
            fill: false,
            borderColor: 'rgb(247, 45, 102)'
        }]
    };
    const config5 = {
        type: 'scatter',
    ...
    const data6 = {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgba(68, 84, 195, 0.2)',
            borderColor: 'rgb(68, 84, 195)',
            pointBackgroundColor: 'rgb(68, 84, 195)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgb(68, 84, 195)'
        }, {
            label: 'My Second Dataset',
            data: [28, 48, 40, 19, 96, 27, 100],
            fill: true,
            backgroundColor: 'rgba(247, 45, 102, 0.2)',
            borderColor: 'rgb(247, 45, 102)',
            pointBackgroundColor: 'rgb(247, 45, 102)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgb(247, 45, 102)'
        }]
    };
    const config7 = {
        type: 'radar',
