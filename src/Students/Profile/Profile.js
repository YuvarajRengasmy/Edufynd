                ...
                <div className="card border-0 shadow">
                  <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <div className="social-links mt-2">
                      ...
                      <Link
                        to={student?.facebook}
                        className="facebook mr-4 fs-5"
                        style={{ color: "#fe5722" }}
                      >
                        <i className="fab fa-facebook" />
                      </Link>
                      <Link
                        to={student?.instagram}
                        className="instagram mr-4 fs-5"
                        style={{ color: "#fe5722" }}
                      >
                ...
                <div className="card border-0 shadow">
                  <div className="card-body pt-3">
                    ...
                    <div className="tab-content pt-2">
                      <div
                        className="tab-pane fade show active profile-overview p-2"
                        id="profile-overview"
                      >
                          ...
                          <div className="col">
                            ...
                            {currentView === "feed" ? (
                              <input
                                className="form-control "
                                id="Email"
                                value={student?.englishLanguageTest}
                              />
                            ) : (
                              <div className=" d-flex col-md-12 col-lg-9 gap-5">
                                <label className="form-label fw-semiold">
                                  English Test Type
                                  <input
                                    className="form-control "
                                    id="Email"
                        ...
                        <div className="row mb-3">
                          ...
                          <div className="col">
                            ...
                            <input
                              ...
                              id="Twitter"
                              value={
                                student?.visaReason ? student?.visaReason : "no"
                              }
                            />
                          </div>
                          <div className="col">
