              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="info-box card text-center border-0 rounded-2 shadow-sm">
                    <i className="bi bi-geo-alt fs-4" style={{ color: "#fe5722" }} ><h5>Address</h5></i>
                ...
                <div className="col-lg-6">
                  <div className="info-box card text-center border-0 rounded-2 shadow-sm ">
                    <i className="bi bi-telephone fs-4 " style={{ color: "#fe5722" }} > <h5>Call Us</h5> </i>
                    <p>+91 94861 54327<br /> +91 04123 45678</p>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="info-box card text-center border-0 rounded-2 shadow-sm ">
                    <i className="bi bi-envelope fs-4" style={{ color: "#fe5722" }}><h5>Email Us</h5></i>
                    <p>info@example.com<br />contact@example.com</p>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="info-box card text-center border-0 rounded-2 shadow-sm">
                    <i className="bi bi-clock fs-4"style={{ color: "#fe5722" }}> <h5>Open Hours</h5></i>
                ...
                <form  onSubmit={handleSubmit}>
                  <div className="row gy-4">
                    ...
                    <div className="col-md-12 text-center">
                      <button className="btn border-0 rounded-2 text-white fw-semibold" type="submit" style={{backgroundColor:"#fe5722"}}>Send Message</button>
                    </div>
                  </div>
                </form>
              </div>
