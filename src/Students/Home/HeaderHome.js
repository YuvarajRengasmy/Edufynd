          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav ms-auto gap-5">
              <li className="nav-item active">
                <Link className="nav-link text-white fw-bold mt-3 " to="/Student">Home</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link text-white fw-bold mt-3 " to="/About">About</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link text-white fw-bold mt-3" to="/Program">Programs</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link text-white fw-bold mt-3" to="/Contact">Contact</Link>
              </li>
