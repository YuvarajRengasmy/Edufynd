                        ...
                        <div className="form-group">
                          <Editor
                            ...
                            init={{
                              ...
                              toolbar: 'undo redo | formatselect | bold italic backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | help | insertfile image media link codesample emoticons | code fullscreen preview save print'
                            }}
                          />
                        </div>
                      </div>
                      ...
                      >
                        <div className="form-group m-0">
                          ...
                          <div className="row m-b-5">
                            <div className="col-sm-12">
                              <label htmlFor="main_image">Add Image</label>
                            </div>
                          ...
                          <div className="row">
                            <div className="col-sm-12 m-b-5">
                              <input
                                ...
                                id="additional_image"
                                placeholder="Add Additional Image"
                                style={{ fontFamily: "Plus Jakarta Sans", fontSize: "12px" }}
                              />
                            </div>
                          </div>
                        ...
                        <div className="form-group">
                          <div className="custom-control custom-checkbox">
                            <input
                              ...
                              style={{ fontFamily: "Plus Jakarta Sans", fontSize: "12px" }}
                            />
                            <label htmlFor="cb_scheduled" className="custom-control-label">
                              Scheduled Post
                            </label>
                          </div>
                        </div>
