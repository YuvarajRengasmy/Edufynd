                    ...
                    <div class="col-md-8">
                      ...
                      <article class="blog-post">
                        ...
                        <p>
                          ...
                          typography, lists, tables, images, code, and more are
                          all supported as expected.
                        </p>
                        <hr />
                        <p>
                          This is some additional paragraph placeholder content.
                          It has been written to fill the available space and
                          show how a longer snippet of text affects the
                          surrounding content. We'll repeat it often to keep the
                          demonstration flowing, so be on the lookout for this
                        ...
                        <p>
                          This is some additional paragraph placeholder content.
                          It's a slightly shorter version of the other highly
                          repetitive body text used throughout. This is an
                        ...
                        <dl>
                          ...
                          <dd>
                            The language used to describe and define the content
                            of a Web page
                          </dd>
                          ...
                          <dt>JavaScript (JS)</dt>
                          <dd>
                            The programming language used to build advanced Web
                      ...
                      <article class="blog-post">
                        ...
                        <blockquote>
                          <p>
                            ...
                            <strong>emphasized text</strong> in the middle of
                            it.
                          </p>
                        </blockquote>
                        <p>
                          ...
                          <ul class="list-unstyled">
                            ...
                            <li>
                              ...
                              >
                                ...
                                <div class="col-lg-8">
                                  <h6 class="mb-0">
                                    Longer blog post title: This one has
                                    multiple lines!
                                  </h6>
                                  <small class="text-body-secondary">
                                    January 13, 2024
