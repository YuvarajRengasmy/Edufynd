    ...
    return (
        ...
        <div  style={{  fontFamily: 'Plus Jakarta Sans', fontSize: '14px' }}>
            ...
            <div className="content-wrapper " style={{  fontFamily: 'Plus Jakarta Sans', fontSize: '12px' }}>
                ...
                <h5 className='text-center text-capitalize p-1'> Add Client Details</h5>
                </div>
                         ...
                         {type.map((data, index) =>
                           ...
                           <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div className="add-customer-btns mb-40 d-flex justify-content-end w-30 ml-auto">
                                    <Link style={{ backgroundColor: "#231F20", fontFamily: 'Plus Jakarta Sans', fontSize: '14px' }} to="/ClientList" className="btn btn-cancel border-0 fw-semibold text-uppercase text-white w-25 m-2">
                                        Cancel
                                    </Link>
