...
const App = () => {
  ...
  const handleValidation = (data) => {
    ...
    if (data.about === "") error.about.required = true;
    if (data.admissionRequirement === "") error.admissionRequirement.required = true;
                    ...
                    <div className="card-body p-4">
                      <div className="row g-3">
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control text-capitalize rounded-1 ${errors.universityName.required ? 'is-invalid' : errors.universityName.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="row g-3 mb-3">
                          ...
                          <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select
                              ...
                              className={`form-select form-select-lg rounded-1 text-capitalize ${errors.commissionType.required ? 'is-invalid' : ''}`}
                              onChange={handleInputs}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control text-lowercase rounded-1 ${errors.email.required ? 'is-invalid' : errors.email.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 text-lowercase ${errors.website.required ? 'is-invalid' : errors.website.valid ? 'is-valid' : ''
                              }`}
...
<div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
  ...
  <Select
    ...
    onChange={handleSelectChange}
    placeholder="Select Course Type"
    classNamePrefix="react-select" // Use classNamePrefix for React-Select-specific styling
    ...
    <div className="text-danger form-text">
      This field is required.
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 ${errors.founded.required ? 'is-invalid' : errors.founded.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 ${errors.ranking.required ? 'is-invalid' : errors.ranking.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 ${errors.averageFees.required ? 'is-invalid' : errors.averageFees.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <Select
                            ...
                            classNamePrefix="react-select"
                            className={`react-select-container ${errors.inTake.required ? 'is-invalid' : ''}`}
                            name="inTake"
                            onChange={handleSelectChange}
                            styles={{
                              container: (base) => ({
  ...
  <div className="form-group">
    ...
    <div
      className={`ckeditor-container ${
        errors.about.required ? "is-invalid" : ""
      }`}
    >
      <CKEditor
        editor={ClassicEditor}
...
<div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
  <div className="form-group">
    <label style={{ color: "#231F20" }}>
      Admission Requirements <span className="text-danger">*</span>
    </label>

    <div
      className={`ckeditor-container ${
        errors.admissionRequirement.required ? "is-invalid" : ""
      }`}
    >
      <CKEditor
        editor={ClassicEditor}
        ...
        onChange={(event, editor) => {
          const data = editor.getData();
          handleRichTextChange(data); // Call the handler when content changes
        }}
        style={{
          fontFamily: "Plus Jakarta Sans",
          fontSize: "12px",
    ...
    {errors.admissionRequirement.required && (
      <div className="text-danger form-text">
        This field is required.
      </div>
    )}
