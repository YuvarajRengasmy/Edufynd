              ...
              <ol className="breadcrumb d-flex justify-content-end align-items-center w-100">
                <li className="flex-grow-1">
                  <div className="input-group" style={{ maxWidth: "600px", fontSize: "14px" }}>
                    <h1 className="fw-bold text-capitalize" style={{ backgroundColor: '#fff', fontFamily: 'Plus Jakarta Sans', fontSize: '15px' }}>Commission PaidOn</h1>
                ...
                <li className="m-2">
                  <div style={{fontFamily: 'Plus Jakarta Sans', fontSize: '13px' }}>
                    <button className="btn btn-primary" style={{ fontSize: '12px' }} type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight1" aria-controls="offcanvasRight"> <FaFilter /></button>
                    <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasRight1" aria-labelledby="offcanvasRightLabel">
                      <div className="offcanvas-header">
                        <h5 id="offcanvasRightLabel">Filter  Commission PaidOn</h5>
                        <button type="button" className="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close" />
                      </div>
                      <div className="offcanvas-body ">
                        <form>
                          <div className="from-group mb-3">
                            <label className="form-label"> Commission PaidOn</label>
                            <br />
                            <input
                              type="text"
                              ...
                              placeholder="Search...Commission PaidOn"
                            />
                ...
                <table className="table table-hover text-nowrap">
                  <thead>
                    <tr style={{ backgroundColor: '#fff', fontFamily: "Plus Jakarta Sans", fontSize: "12px" }}>
                      ...
                      <th className='text-start text-capitalize'>CommissionPaidOn</th>
                    ...
                    {moduleList.length > 0 ? (
                      moduleList.map((data, index) => (
                        <tr key={index} style={{ backgroundColor: '#fff', fontFamily: "Plus Jakarta Sans", fontSize: "11px" }}>
                          ...
                          <td  className='text-start text-capitalize'>{data.commissionPaidOn}</td>
      ...
      <Dialog open={open} onClose={closePopup}>
        ...
        <DialogContent>
          ...
          <div className="text-end mt-3">
            <button
              className="btn btn-danger text-uppercase px-3 py-2 text-white fw-semibold rounded-pill me-2"
              onClick={closePopup}
              style={{fontSize:'10px'}}
            >
             No
            ...
            <button
              className="btn btn-success text-uppercase px-3 py-2 text-white fw-semibold rounded-pill"
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title text-uppercase fw-semibold" id="addPopularModalLabel1">{isEditing ? "Edit " : "Add "}</h5>
              <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div className="modal-body">
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  <label htmlFor="commissionPaidOn" className="form-label">Commission PaidOn</label>
                  <input
                    type="text"
                    className="form-control"
                    id="commissionPaidOn"
                ...
                <div className="text-end">
                  <button type="submit" className="btn btn-sm text-uppercase fw-semibold px-4 py-2  border-0 text-white" style={{backgroundColor:'#fe5722',color:'#fff',fontSize:'12px'}} data-bs-dismiss="modal">{isEditing ? "Update" : "Add"}</button>
                </div>
              </form>
            </div>
          </div>
