...
import { saveStatus, getFilterApplicationStatus, getallStatuses, deleteStatus,getSingleStatus, updateStatus } from '../../../api/StatusEnquiry/student';
    ...
    <div>
          ...
          <div className=" " style={{ fontFamily: "Plus Jakarta Sans", fontSize: "14px"  }}>
            ...
            <div className="card-header  bg-white " >
              ...
              <h6 className=' text-capitalize p-1'>Student Status</h6>
            <button
                          ...
                          data-bs-target="#addCountryModal107"
            ...
            <div className="modal fade" id="addCountryModal107" tabIndex={-1} aria-labelledby="addCountryModalLabel107" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title" id="addCountryModalLabel107">{isEditing ? "Edit Status Type" : "Add Status Type"}</h5>
