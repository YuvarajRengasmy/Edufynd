...
import { saveStatus, getFilterApplicationStatus, getallStatuses, deleteStatus,getSingleStatus, updateStatus } from '../../../api/StatusEnquiry/accomdation'
    ...
    <div>
          ...
          <div className=" " style={{ fontFamily: "Plus Jakarta Sans", fontSize: "14px"  }}>
            ...
            <div className="card-header  bg-white " >
              ...
              <h6 className=' text-capitalize p-1'>Accommodation Status</h6>
            <button
                          ...
                          data-bs-target="#addCountryModal101"
            ...
            <Dialog open={open} onClose={closePopup}>
              ...
              <DialogContent>
                <div>Are you sure you want to delete this Accommodation Status?</div>
            ...
            <div className="modal fade" id="addCountryModal101" tabIndex={-1} aria-labelledby="addCountryModalLabel101" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title" id="addCountryModalLabel101">{isEditing ? "Edit Status Type" : "Add Status Type"}</h5>
