...
import { saveStatus, getFilterApplicationStatus, getallStatuses, deleteStatus,getSingleStatus, updateStatus } from '../../../api/StatusEnquiry/flight';
    ...
    <div>
          ...
          <div className=" " style={{ fontFamily: "Plus Jakarta Sans", fontSize: "14px"  }}>
            ...
            <div className="card-header  bg-white " >
              ...
              <h6 className=' text-capitalize p-1'> Flight Status</h6>
            <button
                          ...
                          data-bs-target="#addCountryModal103"
            ...
            <Dialog open={open} onClose={closePopup}>
              ...
              <DialogContent>
                <div>Are you sure you want to delete this Flight Status?</div>
            ...
            <div className="modal fade" id="addCountryModal103" tabIndex={-1} aria-labelledby="addCountryModalLabel103" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title" id="addCountryModalLabel103">{isEditing ? "Edit Status Type" : "Add Status Type"}</h5>
