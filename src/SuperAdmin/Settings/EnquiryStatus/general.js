...
import { saveStatus, getFilterApplicationStatus, getallStatuses, deleteStatus,getSingleStatus, updateStatus } from '../../../api/StatusEnquiry/general';
    ...
    <div>
          ...
          <div className=" " style={{ fontFamily: "Plus Jakarta Sans", fontSize: "14px"  }}>
            ...
            <div className="card-header  bg-white " >
              ...
              <h6 className=' text-capitalize p-1'> General Enquiry Status</h6>
            <button
                          ...
                          data-bs-target="#addCountryModal105"
            ...
            <Dialog open={open} onClose={closePopup}>
              ...
              <DialogContent>
                <div>Are you sure you want to delete this General Status?</div>
            ...
            <div className="modal fade" id="addCountryModal105" tabIndex={-1} aria-labelledby="addCountryModalLabel105" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title" id="addCountryModalLabel105">{isEditing ? "Edit Status Type" : "Add Status Type"}</h5>
