...
import { saveStatus, getFilterApplicationStatus, getallStatuses, deleteStatus,getSingleStatus, updateStatus } from '../../../api/StatusEnquiry/forex';
    ...
    <div>
          ...
          <div className=" " style={{ fontFamily: "Plus Jakarta Sans", fontSize: "14px"  }}>
            ...
            <div className="card-header  bg-white " >
              ...
              <h6 className=' text-capitalize p-1'> Forex Status</h6>
            <button
                          ...
                          data-bs-target="#addCountryModal104"
            ...
            <div className="modal fade" id="addCountryModal104" tabIndex={-1} aria-labelledby="addCountryModalLabel104" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title" id="addCountryModalLabel104">{isEditing ? "Edit Status Type" : "Add Status Type"}</h5>
