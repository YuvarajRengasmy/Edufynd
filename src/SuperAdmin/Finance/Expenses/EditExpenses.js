...
<h5 className='text-center text-capitalize p-1'> Edit Expenses Details</h5>
</div>
<div className="card-body mt-5">
              <div className="row g-3">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <label style={{ color: "#231F20" }}>
                  	Name Of Expenses <span className="text-danger">*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <label style={{ color: "#231F20" }}>
                Paid Against <span className="text-danger">*</span>
                  </label>
                  <input
                    type="text"
                    className="form-control "
