                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                                    ...
                                                    <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <select
                                                            ...
                                                            style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '14px' }}
                                                            name="universityName"
                                                            value={program?.universityName?program?.universityName:""}
            ...
            <div>
              ...
              />
                          ...
                          <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select className="form-control" value={program?.englishlanguageTest} name="englishlanguageTest" onChange={handleInputs} style={{ backgroundColor: '#fff', fontFamily: 'Plus Jakarta Sans', fontSize: '12px' }}>
...
<select className="form-control" name="greGmatRequirement" value={program?.greGmatRequirement} style={{ backgroundColor: '#fff', fontFamily: 'Plus Jakarta Sans', fontSize: '12px' }} onChange={handleInputs}>
  <option value="">Select Type</option>
    ...
    <label style={{ color: '#231F20' }} className="col-md-4 col-lg-3 col-form-label">
      ...
      />
                          ...
                          <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select className="form-control" value={program?.universityInterview} name="universityInterview" style={{ backgroundColor: '#fff', fontFamily: 'Plus Jakarta Sans', fontSize: '12px' }} onChange={handleInputs}>
                              <option value="">Select Type</option>
