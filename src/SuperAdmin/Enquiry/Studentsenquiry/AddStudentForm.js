                ...
                <form className="p-1" onSubmit={handleSubmit}>
                  <div className="row g-3">
                      ...
                      <div className="row g-3">
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <select
                            ...
                            className={`form-select form-select-lg rounded-1 text-capitalize ${errors.studentName.required ? 'is-invalid' : ''}`}
                            name="studentName"
                          >
                      ...
                      <div className="row gx-4 gy-2">
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <select
                            ...
                            className={`form-select form-select-lg rounded-1 text-capitalize ${errors.agentName.required ? 'is-invalid' : ''} `}
                            name="agentName"
                          >
                          ...
                          <div className="d-flex align-items-end">
                            ...
                            <div className="input-group mb-3">
                              ...
                              <input
                                ...
                                className={`form-control  ${errors.agentPrimaryNumber.required ? 'is-invalid' : ''
                                  }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <div className="input-group mb-3">
                            ...
                            <input
                              type="text"
                              className={`form-control rounded-1 ${errors.agentWhatsAppNumber.required ? 'is-invalid' : ''
                                }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            className={`form-control rounded-1 text-lowercase ${errors.agentEmail.required ? 'is-invalid':''}`}
                            name="agentEmail"
                            onChange={handleInputs}
                            id="inputEmail"
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      ...
                      <input
                        className=
                        {`form-control rounded-1 text-uppercase ${errors.dob.required ? 'is-invalid' : ''}`}
                        onChange={handleInputs}
                        id="inputPassword4"
                        type="date"
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      ...
                      <input
                        className=
                        {`form-control rounded-1 text-capitalize ${errors.citizenShip.required ? 'is-invalid' : ''}`}
                        onChange={handleInputs}
                        name="citizenShip"
                        id="inputPassword4"
                        type="text"
                      ...
                      <div className="d-flex align-items-end">
                        ...
                        <div className="input-group mb-3">
                          ...
                          <input
                            type="text"
                            aria-label="Text input with dropdown button"
                            className={`form-control  ${errors.primaryNumber.required ? 'is-invalid' : ''
                              }`}
                            placeholder="Example 123-456-7890"
                            style={{ fontFamily: "Plus Jakarta Sans", fontSize: "12px" }}
                            name="primaryNumber"
                        ...
                        <div className="d-flex align-items-end">
                          <div className="input-group mb-3">
                            ...
                            <input
                              type="text"
                              aria-label="Text input with dropdown button"
                              className={`form-control  ${errors.refereeContactNo.required ? 'is-invalid' : errors.refereeContactNo.valid ? 'is-valid' : ''
                                }`}
                              placeholder="Example 123-456-7890"
                              style={{ fontFamily: "Plus Jakarta Sans", fontSize: "12px" }}
