    ...
    <div>
      <div style={{fontFamily: 'Plus Jakarta Sans',fontSize: '14px' }}>
        <div className="container-fluid">
          ...
          <div className='content-wrapper' style={{  fontSize: '14px',fontFamily: 'Plus Jakarta Sans', }}>
                ...
                <form className="p-1" onSubmit={handleSubmit}>
                  ...
                  <div className='row g-3'>
                    <div className='d-flex flex-row align-item-center justify-content-end gap-1'>
                      ...
                      <Link style={{ backgroundColor: "#231F20", fontFamily: 'Plus Jakarta Sans', fontSize: '14px' }} to="/ClientList" className="btn btn-cancel border-0 fw-semibold text-uppercase px-4 py-2 text-white m-1">
                        Cancel
                      </Link>

                      <button style={{ backgroundColor: "#FE5722", fontFamily: 'Plus Jakarta Sans', fontSize: '14px' }} type="submit" className="btn btn-save border-0 fw-semibold text-uppercase px-4 py-2  text-white m-1">
                        Submit
                      </button>
