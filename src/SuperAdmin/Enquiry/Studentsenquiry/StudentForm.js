        ...
        <div className="content-header">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb justify-content-end">
              ...
              <li className="breadcrumb-item">
                <Link to="/ListStudentForm" className="text-decoration-none">
                  ListStudentEnquiry
                </Link>
              </li>
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-6">
                        {" "}
                        {formatDate(student?.dob) || "Not Available"}
                      </div>
                    </div>
                    <div class="row mb-3">
                      <div class="col-6 fw-bold">
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-6">
                        {" "}
                        {student?.dial1 + " " + student?.primaryNumber ||
                          "Not Available"}
                      </div>
                    </div>
                    <div class="row mb-3">
                      ...
                      <div class="col-6">
                        {" "}
                        {student?.dial2 + " " + student?.whatsAppNumber ||
                          "Not Available"}
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card mb-3">
                      ...
                      <div class="card-body ">
                        <div class="row mb-3">
                          ...
                          <div class="col-6">
                            {student?.agentName || "Not Available"}
                          </div>
                        </div>
                        <div class="row mb-3">
                          <div class="col-6 fw-bold">
                            <i class="fas fa-graduation-cap"></i>Agent Business
                            Name:
                          </div>
                          <div class="col-6">
                            {student?.businessName || "Not Available"}
                          </div>
                        </div>
                        <div class="row mb-3">
                          <div class="col-6 fw-bold">
                            <i class="fas fa-graduation-cap"></i>Agent Primary
                            Number:
                          </div>
                          <div class="col-6">
                            {student?.dial1 + " " + student?.primaryNumber ||
                        ...
                        <div class="row mb-3">
                          <div class="col-6 fw-bold">
                            <i class="fas fa-graduation-cap"></i>Agent Whatsapp
                            Number:
                          </div>
                          <div class="col-6">
                            {student?.dial2 + " " + student?.whatsAppNumber ||
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-6">
                            {student?.agentEmail || "Not Available"}
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-6">
                        {student?.doYouHoldAnyOtherOffer || "Not Available"}
                      </div>
                    </div>
                    <div class="row mb-3">
                      <div class="col-6 fw-bold">
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-6">
                        {" "}
                        {student?.registerForIELTSClass || "Not Available"}
                      </div>
                    </div>
                    <div class="row mb-3">
                      <div class="col-6 fw-bold">
                      ...
                      <div class="col-6">
                        {" "}
                        {student?.assignedTo || "Not Available"}
                      </div>
                    </div>
                  </div>
                </div>
