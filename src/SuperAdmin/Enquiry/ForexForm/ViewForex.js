                      ...
                      <div className="list-group">
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.agentName||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.businessName||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.agentEmail||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.agentPrimaryNumber||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.agentWhatsAppNumber||"Not Available"}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="list-group">
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.studentName||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.passportNo||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.expiryDate||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          <i className="fas fa-envelope me-2 text-dark "></i>
                          <div>
                            ...
                            <p className="mb-0">{forex.email||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          <i className="fas fa-phone me-2 text-dark "></i>
                          <div>
                            ...
                            <p className="mb-0">{forex.primaryNumber||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          <i className="fab fa-whatsapp me-2 text-success"></i>
                          <div>
                            ...
                            <p className="mb-0">{forex.whatsAppNumber||"Not Available"}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="list-group">
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.country||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">
                              <Flags code={forex.flag} className="me-2" name="flag" style={{ width: '30px', height: '20px' }} />
                        ...
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.amountInCurrency||"Not Available"}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="list-group">
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.assignedTo||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex. markUp||"Not Available"}</p>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="mb-0">{forex.profit||"Not Available"}</p>
                          </div>
                        </div>
                      </div>
                    </div>
