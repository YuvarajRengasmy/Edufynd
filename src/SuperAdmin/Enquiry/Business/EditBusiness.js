          ...
          <div className='content-wrapper' style={{fontSize: '14px' }}>
            <div className='content-header'>
              ...
              <div className="card  border-0 rounded-0 shadow-sm p-3 position-relative">
                ...
                <h5 className='text-center text-capitalize p-1'> Edit BusinessEnquiry Details</h5>
                </div>
                ...
                <form className="p-1" onSubmit={handleSubmit}>
                  ...
                  <div className='row g-2'>
                    <div className='d-flex flex-row align-item-center justify-content-end '>
                      ...
                      <Link style={{ backgroundColor: "#231F20", fontFamily: 'Plus Jakarta Sans', fontSize: '14px' }} to="/ClientList" className="btn btn-cancel border-0 text-uppercase fw-semibold px-4 py-2  text-white m-2">
                        Cancel
                      </Link>
