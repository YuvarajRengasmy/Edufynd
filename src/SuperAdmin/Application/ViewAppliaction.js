                          ...
                          <div className="col-4 border-end border-5 border-primary">
                            ...
                            <div>
                              <StripeCheckout
                                ...
                                name="applicationFee"
                                currency="usd"
                                amount={payment?.amount} // Amount in paise (1 INR = 100 paise)
                              >
                                <button className="btn btn-primary btn-sm" style={{ marginRight: "0.5rem" }}>Pay Now</button>
                                
                              </StripeCheckout>
                              <button className="btn btn-success btn-sm" style={{ marginRight: "0.5rem" }} onClick={makePayment}>Check Out</button>
                            </div>
