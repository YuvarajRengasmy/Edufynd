                    ...
                    <div className="card-body mt-2 ">
                      <div className="row g-3 ">
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 text-capitalize ${errors.empName.required ? 'is-invalid' : errors.empName.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="date"
                            className={`form-control rounded-1 text-uppercase ${errors.dob.required ? 'is-invalid' : errors.dob.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <select
                            ...
                            className={`form-select form-select-lg rounded-1 text-capitalize ${errors.designation.required ? 'is-invalid' : errors.designation.valid ? 'is-valid' : ''
                              }`}
                            style={{ fontSize: "12px" }}
                            name="designation"
                            onChange={handleInputs}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 text-capitalize ${errors.role.required ? 'is-invalid' : errors.role.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control text-uppercase rounded-1 ${errors.doj.required ? 'is-invalid' : errors.doj.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12 ">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 text-capitalize ${errors.reportingManager.required ? 'is-invalid' : ''
                              }`}
                            style={{
                              backgroundColor: "#fff",
                              fontFamily: "Plus Jakarta Sans",
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control rounded-1 text-capitalize ${errors.shiftTiming.required ? 'is-invalid' : errors.shiftTiming.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control rounded-1 text-capitalize ${errors.probationDuration.required ? 'is-invalid' : errors.probationDuration.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 text-lowercase ${errors.email.required ? 'is-invalid' : errors.email.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <select
                            name="team"
                            onChange={handleInputs}
                            className={`form-select form-select-lg rounded-1 text-capitalize ${errors.team.required ? 'is-invalid' : errors.team.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control rounded-1 text-lowercase ${errors.personalMail.required ? 'is-invalid' : errors.personalMail.valid ? 'is-valid' : ''
                              }`}
                          ...
                          <div className="d-flex align-items-end">
                            ...
                            <div className="input-group mb-3">
                              ...
                              <input
                                ...
                                className={`form-control  ${errors.mobileNumber.required ? 'is-invalid' : errors.mobileNumber.valid ? 'is-valid' : ''
                                  }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <div className="input-group mb-3">
                            ...
                            <input
                              type="text"
                              className={`form-control rounded-1 ${errors.emergencyContactNo.required ? 'is-invalid' : errors.emergencyContactNo.valid ? 'is-valid' : ''
                                }`}
                              placeholder="Example 123-456-7890"
                              style={{ fontFamily: "Plus Jakarta Sans", fontSize: "12px" }}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control rounded-1 text-capitalize ${errors.address.required ? 'is-invalid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            type="text"
                            className={`form-control rounded-1 text-capitalize ${errors.address2.required ? 'is-invalid' : ''
                              }`}
                            style={{
                              backgroundColor: "#fff",
                              fontFamily: "Plus Jakarta Sans",
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control rounded-1 text-capitalize ${errors.pin.required ? 'is-invalid' : errors.pin.valid ? 'is-valid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control rounded-1 text-capitalize ${errors.country.required ? 'is-invalid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control rounded-1 text-capitalize ${errors.state.required ? 'is-invalid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input
                            ...
                            className={`form-control rounded-1 text-capitalize ${errors.city.required ? 'is-invalid' : ''
                              }`}
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                          ...
                          <select
                            name="companyAssests"
                            onChange={handleInputs}
                            className={`form-select form-select-lg rounded-1 text-capitalize ${errors.companyAssests.required ? 'is-invalid' : errors.companyAssests.valid ? 'is-valid' : ''
                              }`}
