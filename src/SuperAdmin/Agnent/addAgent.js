                    ...
                    <div className="row g-3 ">
                      ...
                      <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <Select
                          ...
                          className={`react-select-container ${errors.countryInterested.required ? 'is-invalid' : ''}`}
                        ...
                        ></Select>
                         {errors.countryInterested.required && (
                          <span className="form-text text-danger">
                            This field is required.
                          </span>
                        )}
                      ...
                      <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <select
                          ...
                          className={`form-select form-select-lg rounded-1 text-capitalize ${errors.requireVisaFilingSupport.required ? 'is-invalid':''}`}
                        ...
                        {errors.requireVisaFilingSupport.required && (
                          <span className="form-text text-danger">
                            This field is required.
                          </span>
                        )}
