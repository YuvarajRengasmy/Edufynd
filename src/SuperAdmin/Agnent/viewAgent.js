              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="card border-0 text-center">
                    <img
                      src={agent?.agentBusinessLogo || "https://via.placeholder.com/150"}
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <ul className="list-group">
                            ...
                            <li className="list-group-item">
                              <strong>WhatsApp Number:</strong> {agent?.whatsAppNumber}
                            </li>
                            <li className="list-group-item">
                              <strong>Address Line 1:</strong> {agent?.addressLine1}
                            </li>
                            <li className="list-group-item">
                              <strong>Address Line 2:</strong> {agent?.addressLine2}
                            </li>
                            <li className="list-group-item">
                              <strong>Address Line 3:</strong> {agent?.addressLine3}
                            </li>
                          </ul>
                        </div>
                        <div className="col-md-6">
                          <ul className="list-group">
                            ...
                            <li className="list-group-item">
                              <strong>Business Website:</strong> {agent?.businessWebsite}
                            </li>
                            <li className="list-group-item">
                              <strong>GSTN:</strong> {agent?.gstn}
                            </li>
                            <li className="list-group-item">
                              <strong>PAN (Individual):</strong> {agent?.panNumberIndividual}
                            </li>
                            <li className="list-group-item">
                              <strong>PAN (Company):</strong> {agent?.panNumberCompany}
                            </li>
                            <li className="list-group-item">
                              <strong>Staff Name:</strong> {agent?.staffName}
                            </li>
                            <li className="list-group-item">
                              <strong>Staff Contact No:</strong> {agent?.staffContactNo}
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="card-body">
                      <div className="row">
                        <div className="col-md-6">
                          <ul className="list-group">
                            <li className="list-group-item">
                              <strong>Registration No:</strong> {agent?.registrationNo}
                            </li>
                            <li className="list-group-item">
                        ...
                        <div className="col-md-6">
                          <ul className="list-group">
                            <li className="list-group-item">
                              <strong>Require Visa Filing Support:</strong> {agent?.requireVisaFilingSupport ? "Yes" : "No"}
                            </li>
                            <li className="list-group-item">
                              <strong>Visa Commission:</strong> {agent?.visaCommission}
                            </li>
                          </ul>
                        </div>
                      </div>
