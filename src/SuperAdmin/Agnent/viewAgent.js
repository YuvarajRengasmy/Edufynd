                      ...
                      <div className="col-md-12">
                        <div className="row g-4">
                          <div className="col-sm-6">
                            <div className="d-flex flex-row flex-wrap align-items-start justify-content-around">
                              ...
                              <div className="d-flex flex-column align-items-start justify-content-start">
                                ...
                                <p className="card-text text-capitalize fw-bold"><FaFlag style={{ color: '#fe5722' }} />Business Website</p>
                              ...
                              <div className="d-flex flex-column align-items-start justify-content-start">
                                ...
                                <p className="card-text text-capitalize fw-light">busines Website</p>
                          ...
                          <div className="d-flex flex-row flex-wrap align-items-start justify-content-around">
                            <div className="d-flex flex-row flex-wrap align-items-start justify-content-around">
                              <div className="d-flex flex-column align-items-start justify-content-start">
                                <p className="card-text text-capitalize fw-bold"><FaMale style={{ color: '#fe5722' }} />Registration No</p>
                                ...
                                <p className="card-text text-capitalize fw-bold"><FaMale style={{ color: '#fe5722' }} />Staff Name</p>
                                <p className="card-text text-capitalize fw-bold"><FaMale style={{ color: '#fe5722' }} />Staff Contact No</p>
                                <p className="card-text text-capitalize fw-bold"><FaMale style={{ color: '#fe5722' }} />Staff WhatsApp Number</p>
                              ...
                              <div className="d-flex flex-column align-items-start justify-content-start">
                              <p className="card-text text-capitalize fw-light">Registration No</p>
                              <p className="card-text text-capitalize fw-light">{agent?.gstn}</p>
                                ...
                                <p className="card-text text-capitalize fw-light">{agent?.panNumberIndividual}</p>
                                <p className="card-text text-capitalize fw-light">StaffWhatsapp number</p>
                        ...
                        <div className="col-md-6">
                          <div className="d-flex flex-row  align-items-start justify-content-around ">
                            <div className="d-flex flex-column align-items-start justify-content-start">
                              ...
                              <p className="card-text text-capitalize fw-bold"><FaMale style={{ color: '#fe5722' }} />Account Type</p>
                              <p className="card-text text-capitalize fw-bold"><FaFlag style={{ color: '#fe5722' }} />  IFSC</p>
                              <p className="card-text text-capitalize fw-bold"><FaMale style={{ color: '#fe5722' }} />Swift</p>
                            ...
                            <p className="card-text text-capitalize fw-light">Account Type</p>
                            <p className="card-text text-capitalize fw-light">{agent?.ifsc}</p>
                            <p className="card-text text-capitalize fw-light">Swift</p>
                        ...
                        <div className="col-md-6">
                          <div className="d-flex flex-row  align-items-start justify-content-around ">
                            <div className="d-flex flex-column align-items-start justify-content-start">
                              ...
                              <p className="card-text text-capitalize fw-bold"><FaMale style={{ color: '#fe5722' }} />Agents Commission</p>
                              <p className="card-text text-capitalize fw-bold"><FaFlag style={{ color: '#fe5722' }} /> Country Interested</p>
                              <p className="card-text text-capitalize fw-bold"><FaMale style={{ color: '#fe5722' }} />Do require visa filing support</p>
                            ...
                            <p className="card-text text-capitalize fw-light">Do require visa filing suppor</p>
