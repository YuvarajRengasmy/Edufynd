...
export const ListClassSchedule = () => {
            ...
            <div className="row ">
              <div className="col-xl-12">
                <ol className="breadcrumb d-flex flex-row justify-content-end align-items-center w-100">
                  ...
                  <li class="m-1">
                    <Link class="btn btn-pix-primary" to="/agent_add_class_schedule">
                      <button
                              ...
                              <td className="text-capitalize text-start text-truncate">
                                <div className="d-flex">
                                  <Link
                                    ...
                                    to={{
                                      pathname: "/agent_view_class_schedule",
                                    }}
                                  ...
                                  <Link
                                    className="dropdown-item"
                                    to={{
                                      pathname: "/agent_edit_class_schedule",
                                    }}
                                    data-bs-toggle="tooltip"
                                    title="Edit"
                                  >
