  ...
  return (
    <>
      <div>
                          ...
                          <div className="card-body">
                            ...
                            <p className="text-center  float-end text-md-start ">
                                <button
                                  ...
                                  data-bs-toggle="modal" data-bs-target="#AgentProgramApply"
                                  style={{
        ...
        <div class="modal fade" id="AgentProgramApply" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
