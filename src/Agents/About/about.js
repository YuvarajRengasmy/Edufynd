                ...
                <div className="col-xl-12">
                  <div
                    style={{
                      width: "100%",
                      height: "400px",
                      backgroundImage: `url(${"https://campusdirect.io/static/media/banner.b190f2c0.jpg"})`,
                      ...
                      <div className="text-center">
                        <div className="pt-4 text-light text-center ms-5">
                          ...
                          <h4 className="fw-bold ">
                            Explore the vibrant events happening locally and
                            globally.
                          </h4>
                        </div>
                        <div className="mt-5 position-relative">
                          <span
                            className="position-absolute start-25 text-center p-2 px-3 border-0"
                        ...
                        >
                          <div className="team-item bg-light">
                            <div className="overflow-hidden">
                              <img
                                className="img-fluid"
                                src="https://themewagon.github.io/elearning/img/team-1.jpg"
                                alt
                              />
                            </div>
                            <div
