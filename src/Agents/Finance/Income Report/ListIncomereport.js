            ...
            <div className="row ">
              <div className="col-xl-12">
                ...
                <ol className="breadcrumb d-flex flex-row justify-content-end align-items-center w-100">
                  ...
                  <li class="m-1">
                    <Link class="btn btn-pix-primary" to="/agent_add_income_report">
                      <button
                              ...
                              <td className="text-capitalize text-start text-truncate">
                                <div className="d-flex">
                                  <Link
                                    ...
                                    to={{
                                      pathname: "/agent_view_income_report",
                                  ...
                                  <Link
                                    className="dropdown-item"
                                    to={{
                                      pathname: "/agent_edit_income_report",
...
export default ListIncomeReport
