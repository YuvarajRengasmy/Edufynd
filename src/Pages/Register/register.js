             ...
             <div className='navbar-brand d-flex justify-content-center align-items-center gap-3 border-0 p-1 text-white  nav-tab mt-2 text-uppercase fw-bold  mx-auto my-3' style={{ backgroundColor: '#fe5722',color:'#fff',fontSize:'10px' }}>
                     ...
                     <i class="fa fa-user-shield nav-icon text-white"></i> SAdmin
                      ...
                      <button
                        ...
                        style={{ fontSize: '10px' }}>
                    <i class="fa fa-user-secret nav-icon text-white"></i>    Agent
                      </button>
                    </div>
                    ...
                    <span class="input-group-text" id="basic-addon1"><i class="fa fa-user nav-icon"></i></span>
                        ...
                        <div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1"><i class="fa fa-phone nav-icon"></i></span>
                        ...
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-lock nav-icon"></i></span>
                          <input type="password" name="password" onChange={handleInputs} className="form-control form-control-user " id="exampleInputPassword" placeholder="Password..." style={{fontSize:'12px'}} />
                        ...
                        <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-shield-alt nav-icon"></i></span>
                          <input type="password" name="confirmPassword" onChange={handleInputs} className="form-control form-control-user " id="exampleRepeatPassword" placeholder="Confirm Password..." style={{fontSize:'12px'}} />
              ...
              <div className='d-flex justify-content-center'>
                    ...
                    <div className="col-md-6 col-sm-12">
                      <Link to='/'  className="btn btn-sm  px-4 text-uppercase fw-bold py-2" style={{backgroundColor:'#008080',color:'#fff',fontSize:'9px'}} > <i class="fa fa-user-circle nav-icon text-white"></i>Member Login</Link>
                    </div>
                    </div>
                    </form>
             </div>
