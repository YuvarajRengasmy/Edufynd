                                        ...
                                        <div className="row gy-3 py-2">
                                          <div className="col-sm-6">
                                            <div className=" text-lead text-capitalize">
                                              ...
                                              <b> {commission.eligibility}%</b>
                                            </div>
                                          </div>
                                          <div className="col-sm-6">
                                            <div className=" text-lead text-capitalize">
                                              Payment TAT -
                                              <b> {commission.paymentType}</b>
                                            </div>
                                          </div>
                                        </div>
                                        <div className="row gy-3 py-2">
                            ...
                            <div className="row ">
                              ...
                              <div className="col-md-3">
                                <Link
                                  ...
                                  type="button"
                                  class="btn btn-sm text-uppercase text-white fw-semibold px-4 py-2"
                                  style={{
                                    backgroundColor: "#231f20",
                                    color: "#fff",
                                  }}
                                  ...
                                  <div className="card-img-overlay d-flex flex-column justify-content-end text-white ">
                                    ...
                                    <Link
                                      to={{
                                        ...
                                        search: `?id=${university?.universityId}`,
                                      }}
