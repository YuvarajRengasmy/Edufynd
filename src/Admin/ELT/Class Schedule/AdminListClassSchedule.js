...
export const AdminListClassSchedule = () => {
              ...
              <div className="row ">
                <div className="col-xl-12">
                  <ol className="breadcrumb d-flex flex-row justify-content-end align-items-center w-100">
                    ...
                    <li class="m-1">
                      <Link class="btn btn-pix-primary" to="/AdminAddClassSchedule">
                        <button
                                ...
                                <td>
                                  <div className="d-flex">
                                    <Link
                                      ...
                                      to={{
                                        pathname: "/AdminViewClassSchedule",
                                      }}
...
export default AdminListClassSchedule;
