        ...
        <div className="container">
          <div className="row ">
            <div className=" col-lg-12">
              <div className="  border-0 rounded-2 " style={{ width: "100%" }}>
                <div className="">
                  <div className="row">
                    <header className="card-title mt-1">
                      <div className="d-flex flex-row justify-content-between align-items-start">
                        <div className="d-flex flex-column">
                          ...
                          <p className="text-secondary fs1">
                      ...
                      <div className="col-lg-8">
                        <div className="card-body">
                          ...
                          <p className="card-text text-muted mt-1 lh-base px-3 t fs1 fw-light">
                            ...
                            elit. Expedita ducimus quo earum rem culpa corrupti
                            soluta, possimus orporis. Lorem ipsum Lorem ipsum
                  ...
                  <div className="row ">
                    <div className="col-lg-6 mt-1">
                      <div className="card rounded-2 border-0 shadow">
                        <div className="card-body">
                          <h2 className="card-title fs-5 fw-semibold">
                            Activity
                          </h2>
