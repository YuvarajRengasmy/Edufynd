...
const AdminRecieverViewInvoice = () => {
            ...
            <div className="card shadow-sm border-0 text-center p-4">
              <div className="card-body " ref={invoiceRef}>
                  ...
                  <div className="col-sm-6">
                    <div className="d-flex flex-column align-items-center justify-content-start">
                      <p className="card-clientname">
                        Invoice Number: {invoice?.senderInvoiceNumber}
                      </p>
                      <p className="card-clientname">
                        Client Name: {invoice?.businessName}
                      </p>
                      <p className="card-Businessname">
                        University Name: {invoice?.universityName}
                      </p>
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="d-flex flex-column align-items-center justify-content-start">
                      ...
                      <p className="card-Address">
                        Fixed/Percentage: {invoice?.fixedAmount}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-sm-3">
                    <p className="Demand">
                      Course Fees: {invoice?.courseFeesAmount}
                    </p>
                  </div>
                  <div className="col-sm-3">
                  ...
                  <div className="col-sm-3">
                    <p className="Demand">
                      Total Amount: {invoice?.currency} {invoice?.fixedAmount}
                    </p>
                  </div>
                </div>
                <hr />
...
export default AdminRecieverViewInvoice;
