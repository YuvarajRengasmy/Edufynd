        ...
        <Dialog open={open}>
          <DialogContent>
            <div className="text-center m-4">
              ...
              >
                Are you sure you want to Delete <br /> the selected Sender
                Invoice ?
              </h5>
              <button
                type="button"
...
export default AdminListInvoice;
