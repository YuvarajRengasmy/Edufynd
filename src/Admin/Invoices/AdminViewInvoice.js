                                ...
                                <div className='card-body'>
                                    ...
                                    <div className='row g-3'>
                                        <div className='col-sm-3'>
                                            <p className='amount'>Invoice Amount:
                                                INR 70,000
                                            </p>
                                        </div>
                                        <div className='col-sm-3'> <p className='Demand'>Demand Code:XXXX
                                        </p></div>
                                        <div className='col-sm-3'> <p className='amount'>Invoice Amount: 
INR 90,000
                                    ...
                                    <table class="table  table-striped table-responsive-sm table-bordered table-hover">
                                        <thead style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '13px' }}>
                                            <tr>
                                        ...
                                        <tbody style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '12px' }}>
                                            <tr>
