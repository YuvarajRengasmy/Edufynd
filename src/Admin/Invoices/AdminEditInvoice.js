            ...
            <div className="container card card-body p-4 border-0">
              ...
              <form className="p-1">
                <div className="row g-3">
                  ...
                  <hr />
                  <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <label className="form-label" for="inputClientname">
                      Client Name
                    </label>
                    <input
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    ...
                    <select
                      class="form-select"
                      aria-label="Default select example5"
                    >
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <label className="form-label" for="inputcurrency">
                      Currency{" "}
                    </label>
                    <input
                      className="form-control"
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <label className="form-label" for="inputamountreceived">
                      Amount to be received Currency
                    </label>
                    <input
                      className="form-control"
                      ...
                      name="amountreceived"
                      type="text"
                      placeholder="Enter Amount to be received Currency"
                      style={{
                        fontFamily: "Plus Jakarta Sans",
                        fontSize: "12px",
                      }}
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <label className="form-label" for="inputprimarynumber">
                      Amount Received in INR& Currency
                    </label>
                    <input
                      className="form-control"
                      id="inputPrimarynumber"
                      name="amountreceived"
                      type="text"
                      placeholder="EnterAmount Received in INR& Currency"
                      style={{
                        fontFamily: "Plus Jakarta Sans",
                        fontSize: "12px",
                      }}
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <label className="form-label" for="inputinrvalue">
                      INR Value{" "}
                    </label>
                    <input
                      className="form-control"
