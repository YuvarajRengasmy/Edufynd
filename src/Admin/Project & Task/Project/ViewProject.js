  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ fontFamily: "Plus Jakarta Sans", fontSize: "16px" }}
      >
                  ...
                  <div className="accordion" id="projectsAccordion">
                    <div className="accordion-item">
                      ...
                      >
                        ...
                        >
                          <strong>Client:</strong> ABC Corp
                          <br />
                          <strong>Start Date:</strong> 2024-01-01
                          <br />
                          <strong>Due Date:</strong> 2024-08-15
                          <br />
                          <strong>Description:</strong> Development of a new CRM
                          system.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      ...
                      >
                        <div
                          ...
                          style={{ fontSize: "0.9rem", fontWeight: "400" }}
                        >
                          <strong>Client:</strong> XYZ Ltd.
                          <br />
                          <strong>Start Date:</strong> 2024-03-15
                          <br />
                          <strong>Due Date:</strong> 2024-09-01
                          <br />
                          <strong>Description:</strong> Website redesign and
                          development.
                        </div>
                      </div>
                    </div>
