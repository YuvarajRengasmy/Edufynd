...
export const EditProject = () => {
  return (
    ...
    <div className="content-wrapper " style={{  fontFamily: 'Plus Jakarta Sans', fontSize: '13px' }}>
        ...
        <h5 className='text-center text-capitalize p-1'> Edit Project Details</h5>
        </div>
              <div className="card-body mt-5">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <label style={{ color: "#231F20" }}>
                                Status / Percentage Completed<span className="text-danger">*</span>
                                </label>
                                <input
                                    type="text"
                                    className="form-control "
                        ...
                        <div className="add-customer-btns mb-40 d-flex justify-content-end  ml-auto">
                            <Link style={{ backgroundColor: "#231F20", fontFamily: 'Plus Jakarta Sans', fontSize: '12px' }} to="/ListProject" className="btn btn-cancel border-0 fw-semibold text-uppercase text-white px-4 py-2  m-2">
                                Cancel
                            </Link>
