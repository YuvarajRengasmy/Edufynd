                          ...
                          <div className="offcanvas-body ">
                            <form>
                              <div className="from-group mb-3">
                                ...
                                />
                                <label className="form-label">Assigned Partner</label>
                                <br />
                                <input
                                  type="text"
                                  className="form-control"
              ...
              ref={tableRef}>
                     <thead className="table-light">
                       <tr style={{  fontFamily: 'Plus Jakarta Sans', fontSize: '12px' }}>
                         ...
                         <th  className="text-capitalize text-start sortable-handle"> Assigned Partner</th>
        ...
        <DialogContent>
          <div className="text-center m-4">
            <h5 className="mb-4"    style={{fontSize:"14px",fontFamily: 'Plus Jakarta Sans'}}>
              ...
              Are you sure you want to Delete <br /> the selected Accommodation Enquiry ?
            </h5>
            <button
              type="button"
