...
export const AdminListAccommodation = () => {
  const pageSize = 10;
  ...
  const studentPrivileges = staffs?.privileges?.find(privilege => privilege.module === 'accommodationEnquiry');
              ...
              <div className="row">
                <div className="col-xl-12">
                  <ol className="breadcrumb d-flex justify-content-end align-items-center w-100">
                    ...
                    <li class="m-1">
                      <Link class="btn btn-pix-primary" to="/admin_add_accommodation">
                        <button
                                    ...
                                    <td className="text-capitalize text-start">
                                      ...
                                      {studentPrivileges?.view && (
                                        <Link
                                          ...
                                          to={{
                                            pathname: "/admin_view_accommodation",
                                            search: `?id=${data?._id}`,
                                          }}
                                        >
                                      ...
                                      {studentPrivileges?.edit && (
                                        <Link
                                          className="dropdown-item"
                                          to={{
                                            pathname: "/admin_edit_accommodation",
                                            search: `?id=${data?._id}`,
                                          }}
                                        >
        ...
        <Dialog open={open}>
          <DialogContent>
            <div className="text-center m-4">
              ...
              >
                Are you sure you want to Delete <br /> the selected
...
export default AdminListAccommodation;
