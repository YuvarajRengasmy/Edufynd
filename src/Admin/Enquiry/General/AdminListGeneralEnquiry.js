...
export const AdminListGeneralEnquiry = () => {
  ...
  <div style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '14px' }}>
    ...
    <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
      <div className="offcanvas-header">
        <h5 id="offcanvasRightLabel">Filter General Enquiry</h5>
        ...
        <DialogContent>
          <div className="text-center m-4">
            <h5 className="mb-4"    style={{fontSize:"14px",fontFamily: 'Plus Jakarta Sans'}}>
              ...
              Are you sure you want to Delete <br /> the selected Studentt Enquiry ?
            </h5>
            <button
              type="button"
...
export default AdminListGeneralEnquiry;