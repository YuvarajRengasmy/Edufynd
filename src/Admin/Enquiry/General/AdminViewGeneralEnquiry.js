...
export const AdminViewGeneralEnquiry = () => {
          ...
          <div className="content-header">
            ...
            <div className="card  border-0 rounded-0 shadow-sm p-3 position-relative">
              <div className="card-header mt-3 border-0 rounded-end-pill position-absolute top-0 start-0" style={{background:'#fe5722',color:'#fff'}}>
                <h5 className='text-center text-capitalize p-1'>View General Enquiry Details</h5>
                </div>
...
export default AdminViewGeneralEnquiry;
