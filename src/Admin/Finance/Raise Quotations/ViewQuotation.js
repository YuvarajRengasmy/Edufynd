    ...
    <div>
      ...
      >
        <div className="content-header">
                ...
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <textarea
                      ...
                      id="description"
                      rows="3"
                      placeholder="Description of the quotation"
                    ></textarea>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-6">
              ...
              <div class="card-body">
                <div class="list-group">
                  <a
                    ...
                    data-bs-target="#quotationDetailModal"
                  >
          ...
          <div
            class="modal fade"
            id="quotationDetailModal"
            tabindex="-1"
            role="dialog"
            aria-labelledby="quotationDetailModalLabel"
            aria-hidden="true"
          >
            <div class="modal-dialog modal-dialog-scrollable" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="quotationDetailModalLabel">
                    Quotation Details
                  </h5>
                  <button
                    type="button"
