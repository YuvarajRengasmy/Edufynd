...
export const AdminListQuotations = () => {
              ...
              <div className="row ">
                <div className="col-xl-12">
                  <ol className="breadcrumb d-flex flex-row justify-content-end align-items-center w-100">
                    ...
                    <li class="m-1">
                      <Link class="btn btn-pix-primary" to="/AdminAddRaiseQuotations">
                        <button
                                ...
                                <td>
                                  <div className="d-flex">
                                    <Link
                                      ...
                                      to={{
                                        pathname: "/AdminViewRaiseQuotations",
                                      }}
                                    ...
                                    <Link
                                      className="dropdown-item"
                                      to={{
                                        pathname: "/AdminEditRaiseQuotations",
                                      }}
                                      data-bs-toggle="tooltip"
                                      title="Edit"
                                    >
...
export default AdminListQuotations;
