...
export const AdminListIncomeReport = () => {
              ...
              <div className="row ">
                <div className="col-xl-12">
                  <ol className="breadcrumb d-flex flex-row justify-content-end align-items-center w-100">
                    ...
                    <li class="m-1">
                      <Link class="btn btn-pix-primary" to="/AdminListIncomeReport">
                        <button
                                ...
                                <td>
                                  <div className="d-flex">
                                    <Link
                                      ...
                                      to={{
                                        pathname: "/AdminViewIncomeReport",
                                      }}
                                    ...
                                    <Link
                                      className="dropdown-item"
                                      to={{
                                        pathname: "/AdminEditIncomeReport",
                                      }}
                                      data-bs-toggle="tooltip"
                                      title="Edit"
                                    >
...
export default AdminListIncomeReport;
