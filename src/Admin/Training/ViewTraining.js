              ...
              <div className="card border-light shadow-sm p-4">
                <div className="card-body">
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <h4 className="card-training mb-1">
                        Training Topic:{" "}
                        {training?.trainingTopic || "Not Available"}
                      </h4>
                      <p className="text-muted mb-1">
                        <i className="fas fa-calendar-day"></i>&nbsp;&nbsp;
                        Date: {training?.date || "Not Available"}
                      </p>
                      <p className="text-muted mb-1">
                  ...
                  <div className="border-left border-primary pl-4 mb-4">
                    <div className="mb-3">
                      ...
                      <p className="mb-1">
                        Requested by:{" "}
                        {training?.requestTraining || "Not Available"}
                      </p>
                    </div>
                    <div>
                      <h6 className="font-weight-bold text-primary">
                      ...
                      <p className="mb-1">
                        <i className="fas fa-tag"></i>&nbsp;&nbsp; Type of
                        Users: {training?.typeOfUser || "Not Available"}
                      </p>
                      <p className="mb-1">
                        <i className="fas fa-users"></i>&nbsp;&nbsp; Attendees:
                        {Array.isArray(training?.usersName) &&
                        training.usersName.length > 0
                      ...
                      <p className="mb-1">
                        ...
                        Material: {training?.material || "Not Available"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="mb-1">
                      ...
                      &nbsp;&nbsp; Name: {training?.name || "Not Available"}
                    </p>
                    <p className="mb-1">
                      <span className="badge badge-primary">
                    ...
                    <p className="mb-1">
                      ...
                      &nbsp;&nbsp; Subject:{" "}
                      {training?.subject || "Not Available"}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="card-text">
                      <RichTextEditor
                        value={training?.content || "Not Available"}
                        readOnly
                      />
                    </p>
                  </div>
