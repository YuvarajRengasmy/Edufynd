...
/>
  ...
  <Link 
    to="/student_dashboard"
    ref={el => (sidebarRefs.current['/student_dashboard'] = el)}
    className={`nav-link sidebar_link ${activeLink === "/student_dashboard" ? "active" : ""}`}
    onClick={() => handleSetActiveLink("/student_dashboard")}
      data-path="/student_dashboard"
...
<li className="nav-item">
  <Link 
    to="/university_list"
    ref={el => (sidebarRefs.current['/university_list'] = el)}
    className={`nav-link sidebar_link ${
      ["/university_list",].includes(currentPath)
        ? "active"
        : ""
    }`}
    onClick={() => handleSetActiveLink("/university_list")}
   
     data-path="/university_list"
     data-bs-toggle="tooltip"
...
<li className="nav-item">
  <Link 
    to="/program_list"
    ref={el => (sidebarRefs.current['/program_list'] = el)}
    className={`nav-link sidebar_link ${
      ["/program_list",].includes(currentPath)
        ? "active"
        : ""
    }`}
    onClick={() => handleSetActiveLink("/program_list")}
   
     data-path="/program_list"
     data-bs-toggle="tooltip"
     title={isCollapsed ? "University" : ""}
  >
    <i className="fa fa-graduation-cap nav-icon"></i>
...
<li className="nav-item">
  <Link 
    to="/contact" 
    ref={el => (sidebarRefs.current['/contact'] = el)} 
    className={`nav-link sidebar_link ${
...
<li className="nav-item">
  <Link 
    to="/about" 
    ref={el => (sidebarRefs.current['/about'] = el)} 
    className={`nav-link sidebar_link ${
...
<li className="nav-item">
  <Link 
    to="/faq" 
    ref={el => (sidebarRefs.current['/faq'] = el)} 
    className={`nav-link sidebar_link ${
      ["/faq"].includes(currentPath)
        ? "active"
        : ""
    }`}
...
<li className="nav-item">
  <Link 
    to="/track_application"
    ref={el => (sidebarRefs.current['/track_application'] = el)}
    className={`nav-link sidebar_link ${
      ["/track_application", "/student_view_application"].includes(currentPath)
        ? "active"
        : ""
    }`}
    onClick={() => handleSetActiveLink("/track_application")}
     data-path="/track_application"
     data-bs-toggle="tooltip"
