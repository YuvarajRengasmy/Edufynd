                                            ...
                                            <div className="card border-0 rounded-0 mt-2">
                                                <div className="card rounded-0 border-0 text-bg-dark align-items-center">
                                                    <img
                                                        ...
                                                        style={{ mixBlendMode: 'multiply', maxHeight: '15rem' }}
                                                    />
                                                        ...
                                                        <div className="col-md-8">
                                                            <ul className="nav nav-underline fs-9" id="myTab" role="tablist">
                                                                <li className="nav-item" role="presentation">
                                                                    <a className="nav-link active text-uppercase" id="home-tab" data-bs-toggle="tab" href="#tab-home" role="tab" aria-controls="tab-home" aria-selected="true">About</a>
                                                                </li>
                                                                <li className="nav-item" role="presentation">
                                                                    <a className="nav-link text-uppercase" id="profile-tab" data-bs-toggle="tab" href="#tab-profile" role="tab" aria-controls="tab-profile" aria-selected="false" tabIndex="-1">Campus</a>
                                                                </li>
                                                                <li className="nav-item" role="presentation">
                                                                    <a className="nav-link text-uppercase" id="contact-tab" data-bs-toggle="tab" href="#tab-contact" role="tab" aria-controls="tab-contact" aria-selected="false" tabIndex="-1">inTake</a>
                                                                </li>
                                                                <li className="nav-item" role="presentation">
                                                                    <a className="nav-link text-uppercase" id="elt-tab" data-bs-toggle="tab" href="#elt" role="tab" aria-controls="elt" aria-selected="false" tabIndex="-1">ELT</a>
                                                                </li>
                                                                <li className="nav-item" role="presentation">
                                                                    <a className="nav-link text-uppercase" id="acadmic-tab" data-bs-toggle="tab" href="#acadmic" role="tab" aria-controls="acadmic" aria-selected="false" tabIndex="-1">Academic Requirements</a>
                                                                </li>
                                                            </ul>
                                                                                ...
                                                                                {Array.isArray(program?.campuses) &&
                                                                                    program.campuses.map((campus, index) => (
                                                                                        <div key={index} className='col-sm-6 col-md-4 mb-3'>
                                                                                            <div className="card border-0 rounded-3 shadow" style={{ width: '100%', height: "auto" }}>
                                                                                                <img
                                                        ...
                                                        <div className="col-lg-12">
                                                            <div className="row g-3">
                                                                <div className="d-flex flex-row align-items-start justify-content-between mb-3">
                                                                    <div className=" text-decoration-underline text-uppercase" style={{ color: '#fe5722' }}>
                                                                        Programs
                                                                    </div>
                                                                </div>
...
export default ViewStaffProgram