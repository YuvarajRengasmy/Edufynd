...
export const ListPromotions = () => {
  ...
  const studentPrivileges = staff?.privileges?.find(privilege => privilege.module === 'promotion');
                ...
                <div className="col-xl-12">
                  <ol className=" d-flex flex-row justify-content-end align-items-center w-100 mb-0 list-unstyled">
                    ...
                    {studentPrivileges?.add && (
                      <Link class="btn btn-pix-primary" to="/staff_add_promotions">
                        <button
                                      ...
                                      <td className="text-capitalize text-start text-truncate">
                                        ...
                                        {studentPrivileges?.view && (
                                          <Link
                                            ...
                                            to={{
                                              pathname: "/staff_view_promotions",
                                              search: `?id=${data?._id}`,
                                            }}
                                          >
                                        ...
                                        {studentPrivileges?.edit && (
                                          <Link
                                            className="dropdown-item"
                                            to={{
                                              pathname: "/staff_edit_promotions",
                                              search: `?id=${data?._id}`,
                                            }}
                                          >
