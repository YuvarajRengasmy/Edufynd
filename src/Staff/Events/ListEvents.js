...
export const ListEvents = () => {
  ...
  const studentPrivileges = staff?.privileges?.find(privilege => privilege.module === 'events');
              ...
              <div className="col-xl-12">
                <ol className=" d-flex flex-row justify-content-end align-items-center w-100 mb-0 list-unstyled">
                  ...
                  {studentPrivileges?.add && (
                    <Link class="btn btn-pix-primary" to="/staff_add_events">
                      <button
