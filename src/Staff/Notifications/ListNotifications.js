...
export const ListNotifications = () => {
  ...
  const studentPrivileges = staff?.privileges?.find(privilege => privilege.module === 'notification');
              ...
              <div className="col-xl-12">
                ...
                <ol className="d-flex flex-row justify-content-end align-items-center w-100 list-unstyled mb-0">
                  ...
                  {studentPrivileges?.add && (
                    <Link class="btn btn-pix-primary" to="/staff_add_notifications">
                      <button
                            ...
                            <tr key={index}  style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '11px' }}>
                              ...
                              {studentPrivileges?.view && (
                                        <Link
                                          ...
                                          to={{
                                            pathname: "/staff_view_notifications",
                                            search: `?id=${data?._id}`,
                                          }}
                                        >
                              ...
                              {studentPrivileges?.edit && (
                                        <Link
                                          className="dropdown-item"
                                          to={{
                                            pathname: "/staff_edit_notifications",
                                            search: `?id=${data?._id}`,
                                          }}
                                        >
