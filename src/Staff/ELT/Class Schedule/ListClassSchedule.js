            ...
            <div className="row ">
              <div className="col-xl-12">
                <ol className="breadcrumb d-flex flex-row justify-content-end align-items-center w-100">
                  ...
                  <li class="m-1">
                    <Link class="btn btn-pix-primary" to="/staff_add_class_schedule">
                      <button
                              ...
                              <td className="text-capitalize text-start text-truncate">
                                <div className="d-flex">
                                  <Link
                                    ...
                                    to={{
                                      pathname: "/staff_view_class_schedule",
                                    }}
                                  ...
                                  <Link
                                    className="dropdown-item"
                                    to={{
                                      pathname: "/staff_edit_class_schedule",
                                    }}
                                    data-bs-toggle="tooltip"
                                    title="Edit"
                                  >
