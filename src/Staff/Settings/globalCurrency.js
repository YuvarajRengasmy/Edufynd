  ...
  const exportCsv = (event) => {
    ...
    getallOfferTatModule()
      .then((res) => {
        ...
        const header1 = ["country", "currency", "flag"];
        const header2 = ["country", "currency", "flag"];
        ExportCsvService.downloadCsv(list, "country", "Country List", header1, header2);
      })
      .catch((err) => {
        console.log(err);
      });
              ...
              <ol className="breadcrumb d-flex justify-content-end align-items-center w-100">
                <li className="flex-grow-1">
                  <div className="input-group" style={{ maxWidth: "600px", fontSize: "14px" }}>
                    <h1 className="text-bold" style={{ backgroundColor: '#fff', fontFamily: 'Plus Jakarta Sans', fontSize: '15px' }}>offer TAT</h1>
                ...
                <li className="m-2">
                  <div style={{ backgroundColor: '#fff', fontFamily: 'Plus Jakarta Sans', fontSize: '11px' }}>
                    <button className="btn btn-primary" style={{ fontSize: '11px' }} type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight4" aria-controls="offcanvasRight"> <FaFilter /></button>
                    <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasRight4" aria-labelledby="offcanvasRightLabel">
                      <div className="offcanvas-header">
                        <h5 id="offcanvasRightLabel">Filter BY offerTAT</h5>
                ...
                <table className="table table-hover text-nowrap">
                  <thead>
                    <tr style={{ backgroundColor: '#fff', fontFamily: "Plus Jakarta Sans", fontSize: "12px" }}>
                      ...
                      <th className='text-center'>offerTAT</th>
                    ...
                    {moduleList.length > 0 ? (
                      moduleList.map((data, index) => (
                        <tr key={index} style={{ backgroundColor: '#fff', fontFamily: "Plus Jakarta Sans", fontSize: "11px" }}>
                          ...
                          <td className='text-center'>{data.offerTAT}</td>
                          <td>
                            <button
