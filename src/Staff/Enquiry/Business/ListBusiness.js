...
export const ListBusiness = () => {
  ...
  const studentPrivileges = staff?.privileges?.find(privilege => privilege.module === 'businessEnquiry');
                                  ...
                                  <td className="text-capitalize text-start text-truncate">
                                    ...
                                    {studentPrivileges?.view && (
                                      <Link
                                        ...
                                        to={{
                                          pathname: "/staff_view_business_enquiry",
                                          search: `?id=${data?._id}`,
                                        }}
                                     ...
                                     {studentPrivileges?.edit && (
                                      <Link
                                        className="dropdown-item"
                                        to={{
                                          pathname: "/staff_edit_business_enquiry",
                                          search: `?id=${data?._id}`,
                                        }}
                                        data-bs-toggle="tooltip"
                                        title="Edit"
