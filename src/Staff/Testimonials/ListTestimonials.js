...
export const ListTestimonials = () => {
  ...
  const studentPrivileges = staff?.privileges?.find(privilege => privilege.module === 'testimonials');
                ...
                <div className="col-xl-12">
                  <ol className="breadcrumb d-flex flex-row justify-content-end align-items-center w-100 mb-0">
                    ...
                    {studentPrivileges?.add && (
                      <Link class="btn btn-pix-primary" to="/staff_add_testimonials">
                        <button
                                      ...
                                      <td className="text-capitalize text-start text-truncate">
                                        ...
                                        {studentPrivileges?.view && (
                                          <Link
                                            ...
                                            to={{
                                              pathname: "/staff_view_testimonials",
                                              search: `?id=${item?._id}`,
                                            }}
                                        ...
                                        {studentPrivileges?.edit && (
                                          <Link
                                            className="dropdown-item"
                                            to={{
                                              pathname: "/staff_edit_testimonials",
                                              search: `?id=${item?._id}`,
                                            }}
                                            data-bs-toggle="tooltip"
                                            title="Edit"
